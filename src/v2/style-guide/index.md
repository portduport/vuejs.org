...
Esto no quiere decir que el componente es utilizado en una única página, sino que solamente será utilizado una vez _por página_. Este tipo de componente nunca acepta _props_, dado que son específicas para la aplicación, no del contexto de la misma. Si usted encuentra la necesidad de añadir _props_, puede ser un buen indicio de que se trata de un comoponente reusable que se utiliza una vez por página, _por ahora_.
